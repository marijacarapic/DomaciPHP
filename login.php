        ...
        <div class="main-div">
            ...
            <form method="post" action="">
                ...
                <div class="container" style="width: 70%; margin: auto;">
                    ...
                    <label style="color:white; font-size:15px; font-weight:bold" for="username">Korsnicko ime:</label>
                    <input type="text" name="username" class="form-control" required>
                    <br>

                    <label style="color:white; font-size:15px; font-weight:bold"for="password">Lozinka:</label>
                    <input type="password" name="password" class="form-control" required>
                    <br>

                    <button type="submit" class="btn btn-primary" style="background-color:#97694F; width: 80%; margin-left: 10%; margin-top:5%; border: 1px #80da62; border-radius:0%; font-size:20px; font-weight:bold" 
